...
export function Footer() {
  return (
    <footer className="border-t border-primary/10 bg-transparent pb-10 pt-10" data-header-bg="#f6fbfd" id="contact">
      <div className="post-container grid gap-10 lg:grid-cols-[1.25fr_2fr_1fr]">
        <div>
          <Logo />
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 font-body text-[13px] font-medium leading-[22px] text-navy/70">
            <li className="flex gap-2"><Phone size={15} className="text-primary" /> +1 305 394 8070</li>
            <li className="flex gap-2"><Mail size={15} className="text-primary" /> info@itera.health</li>
          </ul>
        </div>
      </div>
      <p className="caption post-container mt-10">
