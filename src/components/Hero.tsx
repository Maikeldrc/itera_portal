...
export function Hero() {
  return (
    <section className="orchestration-hero relative isolate overflow-hidden bg-[#edf7fb]" data-header-bg="transparent" id="top">
      ...
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(247,252,255,0.22)_0%,rgba(237,247,251,0.04)_42%,rgba(237,247,251,0.5)_100%)]" />
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_36%,rgba(255,255,255,0)_0%,rgba(255,255,255,0.08)_52%,rgba(237,247,251,0.38)_100%)]" />
